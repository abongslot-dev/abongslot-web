...
>
  {loading ? (
    <div className="flex items-center gap-1">
                  ...
                  <div className="bg-[#5D3FD3] rounded-full p-0.5 shadow-lg w-full flex justify-between items-center text-white">
                    ...
                    <div className="flex-1 relative"> 
                      <button 
                        ...
                        className={`w-full py-2.5 rounded-full text-[9px] font-bold uppercase border-l border-white/10 ${showDropdown ? 'bg-yellow-400 text-black' : ''}`}
                      >
                        💬 Lainnya
                      </button>
      ...
      {/* --- KONTEN TENGAH --- */}
      <div className="w-full max-w-5xl bg-[#1a0033] p-4 md:p-8 flex flex-col gap-8 shadow-2xl min-h-screen pb-40">
