      ...
      {/* --- BOX RIWAYAT SESUAI GAMBAR --- */}
       <div className="w-full max-w-5xl min-h-[calc(100vh-100px)] bg-white overflow-hidden shadow-2xl border-x border-gray-300 flex flex-col">
        ...
        <div className="bg-[#1a0033] px-4 py-2 border-b border-white/20">
          <h2 className="text-white text-xs font-bold uppercase tracking-wider">Riwayat Saldo</h2>
        </div>
          ...
          <table className="w-full text-[11px] text-center border-collapse">
            <thead>
              <tr className="bg-gray-100 text-zinc-500 uppercase border-b border-gray-300">
                <th className="py-3 px-1 border-r border-gray-300 font-bold">Tanggal</th>
                <th className="py-3 px-1 border-r border-gray-300 font-bold">Transaksi</th>
                <th className="py-3 px-1 border-r border-gray-300 font-bold text-blue-700">Debet</th>
                <th className="py-3 px-1 border-r border-gray-300 font-bold text-red-700">Kredit</th>
                <th className="py-3 px-1 font-bold text-black">Saldo</th>
              </tr>
            </thead>
            <tbody className="text-black">
              {dataRiwayat.length === 0 ? (
                <tr>
                  <td colSpan="5" className="py-10 text-zinc-400 italic bg-white text-sm">Tidak ada data</td>
                </tr>
              ) : (
                dataRiwayat.map((item, i) => (
                  <tr key={i} className="border-b border-gray-200 hover:bg-gray-50">
                    <td className="py-2 border-r border-gray-200">{item.tanggal}</td>
                    <td className="py-2 border-r border-gray-200 uppercase">{item.tipe}</td>
                    <td className="py-2 border-r border-gray-200 text-blue-600 font-bold">{item.debet}</td>
                    <td className="py-2 border-r border-gray-200 text-red-600 font-bold">{item.kredit}</td>
                    <td className="py-2 font-black">{item.saldo}</td>
                  </tr>
                ))
              )}
            </tbody>
